...
for (typekey in DNSRecord.Type) {
  if (Object.prototype.hasOwnProperty.call(DNSRecord.Type, typekey)) {
...
for (typekey in DNSRecord.Class) {
  if (Object.prototype.hasOwnProperty.call(DNSRecord.Class, typekey)) {
